...
⡝⡵⡕⡀⠑⠳⠿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠿⠛⢉⡠⡲⡫⡪⡪⡣]],
        ...
        -- BOTÕES DO MENU
        keys = {
          { icon = " ", key = "f", desc = "Procurar arquivo", action = ":lua require('telescope.builtin').find_files()" },
          { icon = " ", key = "r", desc = "Arquivos recentes", action = ":lua require('telescope.builtin').oldfiles()" },
          { icon = " ", key = "g", desc = "Procurar texto", action = ":lua require('telescope.builtin').live_grep()" },
          { icon = " ", key = "n", desc = "Novo arquivo", action = ":ene | startinsert" },

          { icon = " ", key = "c", desc = "Copilot Chat", action = ":lua require('CopilotChat').toggle()" },
